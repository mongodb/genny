...
This workload is a companion workload of [TimeSeriesLastpoint](#timeserieslastpoint) but focuses
on the run-time benefits of related optimizations by the high group cardinality of 100,000
sensorIds.

Metrics that we care about include MetaAscTimeAsc.RunLastPointQuery\*, MetaAscTimeDesc.RunLastPointQuery\*,
MetaDescTimeDesc.RunLastPointQuery\*, and MetaDescTimeAsc.RunLastPointQuery\*.
