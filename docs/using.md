...
You can also find some example datasets that can be used with generators like `ChooseStringFromDataset`. For more information check [../src/workloads/datasets/README.md](README.md).
