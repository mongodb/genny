...
def _create_compile_environment(
    ...
    cmake_bin_relative_dir = {
        "linux": "downloads/tools/cmake-3.22.2-linux/cmake-3.22.2-linux-x86_64/bin",
        "osx-genny": "downloads/tools/cmake-3.22.2-osx/cmake-3.22.2-Darwin-x86_64/CMake.app/Contents/bin",
    }[triplet_os]
