...
// void parseFindOptions(mongocxx::options::find &, YAML::Node);
// void parseFindOneAndDeleteOptions(mongocxx::options::find_one_and_delete &,
//                                   YAML::Node);
// void parseFindOneAndReplaceOptions(mongocxx::options::find_one_and_replace &,
//                                    YAML::Node);
// void parseFindOneAndUpdateOptions(mongocxx::options::find_one_and_update &,
//                                   YAML::Node);
