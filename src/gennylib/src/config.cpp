...
genny::ActorContext genny::ActorContextFactory::build() const {
    auto out = genny::ActorContext::ActorVector {};
...
genny::ActorContextFactory::ActorContextFactory(const YAML::Node& root,
