...
def generate_rc_timestamp_queries(n_queries):
    return {'t1': uniform_int_queries(0, 10**10, 3600, n_queries),
...
def generate_rc_balance_queries(n_queries):
    return {'t1': [(t[0]/100., t[1]/100.) for t in uniform_int_size_range_queries(80000000, 100000000, 1, 1000, n_queries)],
            't2': [(t[0]/100., t[1]/100.) for t in uniform_int_size_range_queries(80000000, 100000000, 1, 1000000, n_queries)],
            't3': [(t[0]/100., t[1]/100.) for t in uniform_int_size_range_queries(80000000, 100000000, 1, 20000000, n_queries)]}
