...
class CedarIntegrationTest(unittest.TestCase):
    ...
    def test_cedar_main(self):
        expected_result_insert = OrderedDict(
            [
                ...
                ("id", 0),
                ("counters", OrderedDict([("n", 9), ("ops", 58), ("size", 350), ("errors", 23)])),
                ("timers", OrderedDict([("duration", 1320), ("total", 1518)])),
        ...
        expected_result_remove = OrderedDict(
            [
                ("ts", datetime(1970, 1, 1, 2, 46, 40)),
                ("id", 0),
                ("counters", OrderedDict([("n", 9), ("ops", 58), ("size", 257), ("errors", 25)])),
                ("timers", OrderedDict([("duration", 1392), ("total", 1598)])),
                ("gauges", OrderedDict([("workers", 5)])),
            ]
        )
    ...
    def test_cedar_main_2(self):
        ...
        expected_result_insert = [
            OrderedDict(
                [
                    ("ts", datetime.utcfromtimestamp(42 / 1000)),
                    ("id", 1),
                    ("counters", OrderedDict([("n", 1), ("ops", 9), ("size", 300), ("errors", 0)])),
        ...
        expected_result_remove = [
            OrderedDict(
                [
                    ("ts", datetime.utcfromtimestamp(42 / 1000)),
                    ("id", 2),
                    ("counters", OrderedDict([("n", 1), ("ops", 7), ("size", 30), ("errors", 0)])),
            ...
            OrderedDict(
                [
                    ("ts", datetime.utcfromtimestamp(42 / 1000)),
                    ("id", 1),
                    ("counters", OrderedDict([("n", 2), ("ops", 13), ("size", 70), ("errors", 0)])),
        ...
        with tempfile.TemporaryDirectory() as output_dir:
            ...
            self.verify_output(
                pjoin(output_dir, "HelloWorld-Greetings.bson"), [expected_result_greetings]
            )
