...
TEST_CASE_METHOD(MongoTestFixture, "CollectionScanner", "[single_node_replset][three_node_replset][CollectionScanner]") {
...
TEST_CASE_METHOD(MongoTestFixture, "CollectionScannerAll", "[single_node_replset][three_node_replset][CollectionScanner]") {
...
TEST_CASE_METHOD(MongoTestFixture, "CollectionScannerGenerateCollectionNames", "[single_node_replset][three_node_replset][CollectionScanner]") {
