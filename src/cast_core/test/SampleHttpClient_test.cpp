...
TEST_CASE_METHOD(MongoTestFixture, "SampleHttpClient successfully connects to a MongoDB instance.",
          "[standalone][single_node_replset][three_node_replset][sharded][SampleHttpClient]") {
