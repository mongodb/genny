...
TEST_CASE_METHOD(MongoTestFixture, "MinhActor successfully connects to a MongoDB instance.",
          "[standalone][single_node_replset][three_node_replset][sharded][MinhActor]") {
