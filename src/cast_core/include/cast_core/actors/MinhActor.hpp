...
#ifndef HEADER_56B482A8_A40E_4102_955C_C44C9228E9F5_INCLUDED
#define HEADER_56B482A8_A40E_4102_955C_C44C9228E9F5_INCLUDED
 ...
 * ```
 *
 * Or you can fill out the generated workloads/docs/MinhActor.yml
 * file with extended documentation. If you do this, please mention
 * that extended documentation can be found in the docs/MinhActor.yml
 * file.
 *
 * Owner: TODO (which github team owns this Actor?)
 */
class MinhActor : public Actor {
    ...
    // of the work is in the associated `MinhActor.cpp` file and its
    // assocated `MinhActor_test.cpp` integration-test file.
    //
...
public:
    ...
    // .cpp file.
    //
    explicit MinhActor(ActorContext& context);
    ~MinhActor() = default;
    ...
    //
    // This is how Genny knows that `Type: MinhActor` in workload YAMLs
...
private:
    ...
    // `MinhActor.cpp` implementation file.
    //
...
#endif  // HEADER_56B482A8_A40E_4102_955C_C44C9228E9F5_INCLUDED
