...
#ifndef HEADER_9A9E1491_6985_48B0_BB92_15308D41B169_INCLUDED
#define HEADER_9A9E1491_6985_48B0_BB92_15308D41B169_INCLUDED
 ...
 * ```
 *
 * Or you can fill out the generated workloads/docs/CollectionSharder.yml
 * file with extended documentation. If you do this, please mention
 * that extended documentation can be found in the docs/CollectionSharder.yml
 * file.
 *
 * Owner: TODO (which github team owns this Actor?)
 */
class CollectionSharder : public Actor {
    ...
    // of the work is in the associated `CollectionSharder.cpp` file and its
    // assocated `CollectionSharder_test.cpp` integration-test file.
    //
...
public:
    ...
    // .cpp file.
    //
    explicit CollectionSharder(ActorContext& context);
    ~CollectionSharder() = default;
    ...
    //
    // This is how Genny knows that `Type: CollectionSharder` in workload YAMLs
...
private:
    ...
    //
    genny::metrics::Operation _shardCollectionMetrics;

    //
    // The below struct and PhaseConfig are discussed in depth in the
    // `CollectionSharder.cpp` implementation file.
    //
...
#endif  // HEADER_9A9E1491_6985_48B0_BB92_15308D41B169_INCLUDED
